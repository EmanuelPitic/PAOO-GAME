...
public class StartFinishDoor extends StaticEntity {
...
*/
    public StartFinishDoor(RefLinks refLink, float x, float y, boolean solid) {
        super(refLink, x, y, Tile.TILE_WIDTH, Tile.TILE_HEIGHT,"StartFinishDoor", solid);
        bounds.x=0;
        bounds.y=0;
        bounds.width=width;
